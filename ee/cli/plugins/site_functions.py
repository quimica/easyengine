...
def site_package_check(self, stype):
    ...
    if self.app.pargs.php and self.app.pargs.php7:
        Log.error(self,"INVALID OPTION: PHP 7.2 provided with PHP 5.0")
    ...
    if self.app.pargs.php7 and stype in [ 'mysql', 'wp', 'wpsubdir', 'wpsubdomain']:
        if (EEVariables.ee_platform_codename == 'trusty' or EEVariables.ee_platform_codename == 'bionic'):
            ...
            if EEVariables.ee_platform_codename == 'wheezy':
                Log.warn(self, "PHP 7.2 not available for your system.")
    ...
    if self.app.pargs.php7:
        if (EEVariables.ee_platform_codename == 'wheezy' or EEVariables.ee_platform_codename == 'precise'):
            Log.error(self,"PHP 7.2 is not supported in your Platform")
