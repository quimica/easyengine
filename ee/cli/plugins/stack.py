...
#                dict(help='Install Nginx mainline stack', action='store_true')),
    ...
    def pre_pref(self, apt_packages):
        ...
        if set(EEVariables.ee_hhvm).issubset(set(apt_packages)):
            if EEVariables.ee_platform_codename != 'bionic':
    ...
    def post_pref(self, apt_packages, packages):
        ...
        if len(apt_packages):
            ...
            #        http2 = ("http2" if set(["nginx-mainline"]).issubset(set(apt_packages)) else "spdy")
                    ...
                    #php7 conf
                    if (EEVariables.ee_platform_codename == 'jessie' or EEVariables.ee_platform_codename == 'trusty' or EEVariables.ee_platform_codename == 'bionic') and (not
            ...
            if set(EEVariables.ee_hhvm).issubset(set(apt_packages)):
                ...
                EEFileUtils.searchreplace(self, "/etc/hhvm/server.ini",
                                                "9000", "8000")
                if not EEVariables.ee_platform_codename == 'bionic':
            ...
            if (EEVariables.ee_platform_codename == 'trusty' or EEVariables.ee_platform_codename == 'bionic') and set(EEVariables.ee_php5_6).issubset(set(apt_packages)):
                # Create log directories
        ...
        #PHP7.2 configuration for debian
            if (EEVariables.ee_platform_codename == 'jessie' ) and set(EEVariables.ee_php7_2).issubset(set(apt_packages)):
                 # Create log directories
            ...
            if (EEVariables.ee_platform_codename == 'trusty' or EEVariables.ee_platform_codename == 'bionic') and set(EEVariables.ee_php7_2).issubset(set(apt_packages)):
                # Create log directories
                if not os.path.exists('/var/log/php/7.2/'):
                    Log.debug(self, 'Creating directory /var/log/php/7.2/')
                    os.makedirs('/var/log/php/7.2/')
